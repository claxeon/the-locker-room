  ...
  return (
    <motion.div
      ...
      onMouseEnter={e => {
        ...
        el.style.borderColor = '#4a4a70'
        el.style.backgroundColor = 'rgba(37,37,64,0.90)'
      }}
      onMouseLeave={e => {
        const el = e.currentTarget as HTMLDivElement
        el.style.borderColor = 'rgba(58,58,92,0.80)'
        el.style.backgroundColor = 'rgba(26,26,46,0.60)'
      }}
    >
      {/* Periwinkle left-rail accent */}
      <div
        className="h-10 w-0.5 flex-shrink-0 rounded-full transition-colors"
        style={{ backgroundColor: 'rgba(124,126,184,0.40)' }}
      />
      ...
      {school.logo_url ? (
        <div className="relative h-14 w-14 flex-shrink-0">
          <div
            ...
            style={{ border: '1px solid #3a3a5c', backgroundColor: 'rgba(15,15,26,0.80)' }}
          >
            <img
              src={school.logo_url}
      ...
      <div className="flex flex-shrink-0 flex-col items-end gap-1.5">
        {sportLabel && (
          <span
            ...
            style={{
              border: '1px solid rgba(124,126,184,0.25)',
        ...
        {genderLabel && (
          <span
            ...
            style={{
              ...
              backgroundColor: 'rgba(37,37,64,0.60)',
              color: '#8888a8',
            }}
          >
            {genderLabel}
